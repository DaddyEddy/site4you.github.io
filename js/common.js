$(document).ready(function() {
	...
	$(".main_cats_item_wrapp ul").each(function(){
		$(this).after("<div class='main_cats_item_wrapp_af'></div>");
	});	
	$(".mc_toggle").click(function() {
		if($(this).parent().parent().children("ul").is(":visible")) {
		$(this).parent().parent().children("ul").slideUp();
		$(this).parent().parent().children(".main_cats_item_wrapp_af").hide();	
		} else {
			$("body .main_cats_wrapp .main_cats_item_wrapp > ul, .main_cats_item_wrapp_af").hide();
			$(".main_cats_item_wrapp").removeClass("active");
			$(this).parent().parent().addClass("active");
			$(this).parent().parent().children("ul").slideDown();
			$(this).parent().parent().children(".main_cats_item_wrapp_af").show();
		}
	});
